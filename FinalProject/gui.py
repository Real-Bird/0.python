...
class Ui_Ninja_Turtle(QWidget):
    def setupUi(self, Ninja_Turtle):
        Ninja_Turtle.setObjectName("Stop_TurtleNeck")
        ...
        self.label.setPixmap(QtGui.QPixmap("D:/jb_python/FinalProject/turtle.png").scaled(225,220))
    ...
    def retranslateUi(self, Ninja_Turtle):
        ...
        Ninja_Turtle.setWindowTitle(_translate("Stop_TurtleNeck", "Stop_TurtleNeck"))
        self.pushButton.setText(_translate("Stop_TurtleNeck", "Start"))
        self.pushButton.clicked.connect(self.exit)

        self.pushButton_2.setText(_translate("Stop_TurtleNeck", "Stop"))
        self.pushButton_2.clicked.connect(self.start_webcam)

        self.pushButton_3.setText(_translate("Stop_TurtleNeck", "Exit"))
